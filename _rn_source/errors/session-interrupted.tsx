        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Session Interrupted</Text>
                ...
                <View style={styles.titleSection}>
                    <Text style={styles.headline}>Session paused.</Text>
                    <Text style={styles.subheadline}>You were away for 12 minutes.</Text>
                </View>
                ...
                <View style={styles.detailCard}>
                    ...
                    <View style={styles.valueItem}>
                        ...
                        <View style={styles.info}>
                            <Text style={styles.itemTitle}>Resume</Text>
                    ...
                    <View style={styles.valueItem}>
                        ...
                        <View style={styles.info}>
                            <Text style={styles.itemTitle}>Restart from this question</Text>
