...
export default function ProcessingTimeoutScreen() {
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Processing Timeout</Text>
                ...
                <View style={styles.titleSection}>
                    <Text style={styles.headline}>Still processing.</Text>
                    <Text style={styles.subheadline}>This is taking longer than usual.</Text>
                </View>
                ...
                <View style={styles.detailCard}>
                    <Text style={styles.detailTitle}>What you can do</Text>
                    ...
                    <View style={styles.valueItem}>
                        ...
                        <View style={styles.info}>
                            <Text style={styles.itemTitle}>Retry analysis</Text>
                    ...
                    <View style={styles.valueItem}>
                        ...
                        <View style={styles.info}>
                            <Text style={styles.itemTitle}>Skip scoring</Text>
                            <Text style={styles.itemSubtitle}>Ready</Text>
                        </View>
            ...
            <View style={styles.footer}>
                ...
                >
                    <Text style={styles.buttonText}>Continue Waiting</Text>
                </Pressable>
            </View>
        </SafeAreaView>
    );
